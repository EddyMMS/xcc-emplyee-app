...
public class EmployeeTest123 {
    ...
    public void testValidate_HoursPerWeekIncorrect(){
        ...
        assertEquals("Hours per Week is not valid!", exception.getMessage());
    }
    ...
    public void testValidate_HourlyRateIncorrect(){
        ...
        assertEquals("Hourly Rate is not valid!", exception.getMessage());
    ...
    public void testValidate_BirthdateIncorrect(){
        ...
        assertEquals("The date you entered is in the future! Please enter a valid birthdate!", exception.getMessage());
    ...
    public void testValidate_TooYoungToWork(){
        ...
        assertEquals("You're too young to work!", exception.getMessage());
    ...
    public void testValidate_EmployeeData(LocalDate birthDate, double hourlyRate, int hoursPerWeek, String expectedMessage) {
        Exception exception = assertThrows(AppValidationException.class, () -> new Employee(
                birthDate,
                hourlyRate,
                hoursPerWeek,
