...
@Repository
public class CustomAccountMongoRepository {

    private MongoTemplate mongoTemplate;
    private DefaultAccountMongoRepository defaultAccountMongoRepository;
    private PasswordEncoder passwordEncoder;

    public CustomAccountMongoRepository(MongoTemplate mongoTemplate, PasswordEncoder passwordEncoder, DefaultAccountMongoRepository defaultAccountMongoRepository) {
    ...
    public Optional<GithubAccount> findGithubAccountByGithubId(int githubId) {
        return Optional.ofNullable(mongoTemplate.findOne(Query.query(Criteria.where("githubId").is(githubId)), GithubAccount.class));
    }
