package tech.mms.cos.repository.employee;
...
// Anlegen eines neuen Eompoyees ßber das Programm in der MongoDB (Nutzung des ServiceLocators)
// (NoSQLBOoster)
...
// Hat der Employee in der MongoDB eine ID. Falls nein, warum nicht. Falls ja, was ist die ID und wo
// kommt sie her
/*
...
// MongoDB: Collection (im Verlgeich zu Relationaler Datenbank), Was ist ein Index, Was ist ein
// Shard
/*
...
@Primary
@Repository
public interface MongoEmployeeRepository
    extends MongoRepository<Employee, String>, EmployeeRepository {
