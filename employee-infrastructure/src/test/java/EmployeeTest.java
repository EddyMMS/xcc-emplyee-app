...
public class EmployeeTest {
  ...
  static Stream<Arguments> provideInvalidEmployeeData() {
    return Stream.of(
        Arguments.of(
            LocalDate.of(1989, 12, 1), 5.5, -1, EmployeeErrorMessage.hoursPerWeekIsNegativ),
  ...
  void testValidate_EmployeeData(
      LocalDate birthDate, double hourlyRate, int hoursPerWeek, String expectedMessage) {
    Exception exception =
        assertThrows(
            AppValidationException.class,
            () ->
