...
import tech.mms.cos.employee.adapter.random.RandomEmployeeGeneratorApi;
...
public class WireMockTestIT extends AbstractIntegrationTest {
  ...
  @Autowired RandomEmployeeGeneratorApi employeeGeneratorApi;
            ...
            .results(
                List.of(
                    new RandomEmployeeEmployeeDTO()
                        .gender("female")
                        .name(new RandomEmployeeNameDTO().first("Hans").last("Musterfrau"))));
