...
public class NameTest {
  ...
  public void testValidate_FirstNameIsNull() {
    ...
    Exception exception =
        assertThrows(
            AppValidationException.class, () -> new Name(null, validMiddleName, validLastName));
  ...
  public void testValidate_FirstNameIsBlank() {
    ...
    Exception exception =
        assertThrows(
            AppValidationException.class, () -> new Name("", validMiddleName, validLastName));
  ...
  public void testValidate_MiddleNameIsNotValid() {
    ...
    Exception exception =
        assertThrows(
            AppValidationException.class, () -> new Name(validFirstName, "", validLastName));
  ...
  public void testValidate_LastNameIsNull() {
    ...
    Exception exception =
        assertThrows(
            AppValidationException.class, () -> new Name(validFirstName, validLastName, null));
  ...
  public void testValidate_LastNameIsBlank() {
    ...
    Exception exception =
        assertThrows(
            AppValidationException.class, () -> new Name(firstName, middleName, blankLastName));
  ...
  public void testValidate_Names(
      String firstName, String middleName, String lastName, String expectedErrorMessage) {
    Exception exception =
        assertThrows(AppValidationException.class, () -> new Name(firstName, middleName, lastName));
